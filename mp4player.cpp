...
int main() {
	...
	string source_url = "F:/forgit/gitrep/mp4player/mp4player/test.mp4";
...
int init_sdl() {
	...
	// 创建窗体
	sdl_window = SDL_CreateWindow("video player", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
		mWidth/2, mHeight/2, SDL_WINDOW_ALLOW_HIGHDPI);
	if (sdl_window == NULL) {
